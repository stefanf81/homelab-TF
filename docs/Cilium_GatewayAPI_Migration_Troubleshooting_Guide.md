...
| :--- | :--- | :--- |
| **CNI (Network Engine)** | Flannel (Standard iptables encapsulation) | **Cilium v1.16.1 (eBPF-native routing)** |
...
| **Default Hostname** | Host Node IP Address only | **`paintlab.duckdns.org`** & **Wildcard IP routing** |
